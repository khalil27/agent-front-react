...
React.useEffect(() => {
  ...
  console.log("🔎 connectionDetails reçu:", connectionDetails);

  if (room.state === 'disconnected') {
    room
      .connect(connectionDetails.serverUrl, connectionDetails.participantToken)
      .then(() => {
        console.log("✅ Connecté au room, j’active le micro…");
        
        // Définir le nom du participant
        room.localParticipant.setName(connectionDetails.participantName);
